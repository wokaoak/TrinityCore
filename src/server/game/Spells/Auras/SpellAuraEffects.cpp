...
void AuraEffect::HandlePeriodicDamageAurasTick(Unit* target, Unit* caster) const
{
    ...
    //修改伤害，DOT伤害
    aaCenter.AA_ModifyDamage(caster, target, damage, GetSpellInfo(), true, false);
    ...
    //修改伤害，DOT伤害，真实伤害
    aaCenter.AA_ModifyZhenshi(caster, target, damage, GetSpellInfo(), true, false);
...
void AuraEffect::HandlePeriodicHealAurasTick(Unit* target, Unit* caster) const
{
    ...
    aaCenter.AA_ModifyDamage(caster, target, damage1, GetSpellInfo(), true, true);
