            ...
            if (conf.a != "" || conf.b != "" || conf.c != "" || conf.d != "") {
                if (receivemsg == "a" || receivemsg == "A" || receivemsg == "b" || receivemsg == "B" ||
                    ...
                    if (aaCenter.aa_dati_ok[player->GetGUID()]) {
                        aaCenter.AA_SendMessage(player, 1, "|cFF00FFFF[有|r|cFF00D9FF奖|r|cFF00B3FF问|r|cFF008DFF答|r|cFF00FFFF]|r|cffFF0000该题你已经回答过，无法继续作答!");
                    }
                    else {
                        ...
                        if (aaCenter.aa_world_confs[97].value1 == 0) { //抢答模式
                            if (aaCenter.aa_dati_first_name != "") {
                                std::string msg = "|cFF00FFFF[有|r|cFF00D9FF奖|r|cFF00B3FF问|r|cFF008DFF答|r|cFF00FFFF]|r|cffFF0000该题已经被玩家[" + aaCenter.aa_dati_first_name + "]抢答！";
                                aaCenter.AA_SendMessage(player, 1, msg.c_str());
                            }
                            else {
                                if (receivemsg == conf.result) {
                                    if (conf.gm_win != "" && conf.gm_win != "0") {
                                        aaCenter.AA_SendMessage(player, 1, "|cFF00FFFF[有|r|cFF00D9FF奖|r|cFF00B3FF问|r|cFF008DFF答|r|cFF00FFFF]|r|cffFF0000恭喜你，抢答正确!");
                                    ...
                                    if (conf.gm_lose != "" && conf.gm_lose != "0") {
                                        ...
                                        aaCenter.AA_SendMessage(player, 1, "|cFF00FFFF[有|r|cFF00D9FF奖|r|cFF00B3FF问|r|cFF008DFF答|r|cFF00FFFF]|r|cffFF0000回答错误，不能继续回答此题!");
                                    }
                                }
                            }
                        }
                            ...
                            if (receivemsg == conf.result) {
                                if (conf.gm_win != "" && conf.gm_win != "0") {
                                    aaCenter.AA_SendMessage(player, 1, "|cFF00FFFF[有|r|cFF00D9FF奖|r|cFF00B3FF问|r|cFF008DFF答|r|cFF00FFFF]|r|cffFF0000恭喜你，回答正确!");
                                    aaCenter.AA_DoCommand(player, conf.gm_win.c_str());
                                }
                            }
                            else {
