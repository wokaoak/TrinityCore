...
{
public:
    aa_object_teleport() : GameObjectScript("aa_object_teleport") { }

    struct aa_object_teleportAI : public GameObjectAI
    {
        aa_object_teleportAI(GameObject* go) : GameObjectAI(go) { }
    ...
    {
        return new aa_object_teleportAI(go);
    };
};

void AddAA_Object_Teleport()
{
    new aa_object_teleport();
}
